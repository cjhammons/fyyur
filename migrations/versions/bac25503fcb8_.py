...
Revision ID: bac25503fcb8
Revises: a0d973c2f563
Create Date: 2020-05-11 11:28:58.614370
...
revision = 'bac25503fcb8'
down_revision = 'a0d973c2f563'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.Column('seekint_description', sa.String(), nullable=False),
    sa.Column('image_link', sa.String(length=500), nullable=True),
    sa.Column('facebook_link', sa.String(length=120), nullable=True),
    sa.PrimaryKeyConstraint('id')
    )
